...
const RestaurantData = [
        {
          "info": {
            ...
            "availability": {
              "nextCloseTime": "2024-03-01 22:15:00",
              "opened": true
            },
            "badges": {
              "imageBadges": [
...
const RestaurantCard = ({
    ...
    return (
        <div className="card">
            <img className="foodImage" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} alt="food" />
            <p>{name}</p>
            <p>{cuisines.join(", ")}</p>
            <p>{avgRating}</p>
        </div>  
